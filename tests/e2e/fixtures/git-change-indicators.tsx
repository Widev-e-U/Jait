...
import { useGitChangeCounts } from '../../../apps/web/src/lib/git-service'
...
function Harness() {
  ...
  const fileCount = useGitChangeCounts(nodeId, projectRoot, refreshSignal).fileCount
  return <>
    ...
    <GitDiffIndicator projectRoot={projectRoot} nodeId={nodeId} refreshSignal={refreshSignal} onOpen={() => {}} />
