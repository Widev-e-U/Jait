...
import { ProjectPreviewInspectPanel, type PreviewInspectRenderState } from './project-preview-inspect-panel'

describe('ProjectPreviewInspectPanel', () => {
  it('renders active element, dialogs, obstruction, and selector diagnostics', () => {
    ...
    const markup = renderToStaticMarkup(
      createElement(ProjectPreviewInspectPanel, {
        inspectState,
