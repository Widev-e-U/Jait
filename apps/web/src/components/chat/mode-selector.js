...
export function ModeSelector({ mode, onChange, disabled, className }) {
    ...
    return (<DropdownMenu>
      ...
      <DropdownMenuContent align="start" side="top" className="w-64">
        {MODES.map((m) => {
            ...
            return (<DropdownMenuItem key={m.value} onClick={() => onChange(m.value)} className="flex items-start gap-2.5 py-2 cursor-pointer">
