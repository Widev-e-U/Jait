...
describe('tool call body helpers', () => {
  it('normalizes multi-segment tool names used by tool cards', () => {
    ...
    expect(normalizeToolName('windows_sandbox_start')).toBe('windows.sandbox.start')
    expect(normalizeToolName('windows_sandbox_stop')).toBe('windows.sandbox.stop')
    expect(normalizeToolName('linux_desktop_sandbox_start')).toBe('linux.desktop.sandbox.start')
    expect(normalizeToolName('linux_desktop_sandbox_stop')).toBe('linux.desktop.sandbox.stop')
