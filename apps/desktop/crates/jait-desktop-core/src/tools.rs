//! tools — remote tool execution (mirror of legacy desktop tool implementation).
//!
...
/// xdg-open fails silently on headless systems (parity with the legacy shell shell
