...
async function loadApp(win) {
    if (IS_DEV) {
        ...
        try {
            ...
            win.loadURL(`data:text/html,<html><body style="background:#09090b;color:#fafafa;font-family:system-ui;display:flex;align-items:center;justify-content:center;height:100vh;margin:0">` +
...
ipcMain.handle("desktop:confirm-share", async (_event, opts) => {
...
ipcMain.handle("desktop:browse-path", async (_event, dirPath) => {
