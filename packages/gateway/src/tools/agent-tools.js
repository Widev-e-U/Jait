 ...
 */
import { runAgentLoop, buildToolSchemas, SteeringController, } from "./agent-loop.js";
...
function buildSubAgentSystemPrompt(description, details) {
    return [
...
export function createAgentSpawnTool(deps) {
    ...
    return {
        ...
        async execute(input, context) {
            ...
            const subExecuteTool = async (name, args, sid, _auth, onChunk, signal) => {
