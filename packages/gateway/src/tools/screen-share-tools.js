export function createScreenShareTool(screenShare, ws) {
    return {
        name: "screen.share",
        description: "Connect to a remote device and view its screen, or manage remote screen viewing sessions. " +
...
export function createScreenCaptureTool(screenShare) {
    return {
        name: "screen.capture",
...
export function createScreenRecordTool(screenShare) {
    return {
        name: "screen.record",
...
export function createOsTool(screenShare, name) {
    return {
        name,
            ...
            try {
                switch (input.action) {
                    ...
                    case "register-device": {
                        if (!input.device)
                            return { ok: false, message: "device payload is required." };
                    ...
                    case "transfer-control": {
                        if (!input.controllerDeviceId)
                            return { ok: false, message: "controllerDeviceId is required." };
                    ...
                    case "transport-update": {
                        if (!input.transport)
                            return { ok: false, message: "transport payload is required." };
...
//# sourceMappingURL=screen-share-tools.js.map