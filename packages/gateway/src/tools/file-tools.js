...
export function createFileReadTool(registry) {
    return {
        name: "file.read",
...
export function createFileWriteTool(registry) {
    return {
        name: "file.write",
...
export function createFilePatchTool(registry) {
    return {
        name: "file.patch",
...
export function createFileListTool(registry) {
    return {
        name: "file.list",
...
export function createFileStatTool(registry) {
    return {
        name: "file.stat",
