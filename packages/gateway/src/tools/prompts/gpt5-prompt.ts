...
function isGpt5Family(endpoint: ModelEndpoint): boolean {
...
function resolveReminderInstructions(_mode: ChatMode, endpoint: ModelEndpoint): string {
...
const Gpt5PromptResolver: IAgentPrompt = {
  name: "gpt5",
  familyPrefixes: [],
