    ...
    return {
        ...
        async execute(input, context) {
            ...
            if (mode === "fetch") {
                ...
                const results = await Promise.allSettled(allUrls.map((u) => fetchInner.execute({ url: u, method: input.method, maxBytes: input.maxBytes }, context)));
