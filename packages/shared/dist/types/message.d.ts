...
export type UICommandType = "workspace.open" | "workspace.close" | "terminal.focus" | "file.highlight" | "dev-preview.open" | "screen-share.open" | "screen-share.close" | "architecture.update";
 ...
 */
export type UIStateKey = "workspace.panel" | "dev-preview.panel" | "workspace.tabs" | "workspace.layout" | "screen-share.panel" | "terminal.panel" | "chat.mode" | "chat.responseStyle" | "chat.providerRuntimeMode" | "chat.cliModels" | "chat.view" | "todo_list" | "changed_files" | "queued_messages" | "queued_thread_messages";
