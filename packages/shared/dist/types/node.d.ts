export declare const NODE_PROTOCOL_VERSION = 1;
export type NodePlatform = "windows" | "macos" | "linux" | "android" | "ios" | "web";
export type NodeRole = "gateway" | "desktop" | "mobile" | "browser" | "remote";
