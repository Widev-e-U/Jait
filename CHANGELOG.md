...
- fix(gateway): stop quarantining re-reads whose earlier result was compacted — 969dbb57

## [v0.1.838](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.838) — 2026-09-10
- feat(web): unify panel chat composer and fix floating indicator overlap — 612769b5
...
## [v0.1.831](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.831) — 2026-09-08
- fix(gateway): isolate concurrent scheduler jobs — 28bf7d0e
- fix(web): decouple editor from sidebar navigation — e266fcd5
...
## [v0.1.816](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.816) — 2026-09-03
- feat(chat): fork sessions into parallel Ask-in-parallel branch chats — 31f3c841

## [v0.1.815](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.815) — 2026-09-02
- feat(gateway): archive stale sessions in retention sweep — 91aa84fc

## [v0.1.814](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.814) — 2026-09-02
- perf(gateway): replace /health count scans with indexed COUNT(*) — 6f9fb2f7
...
## [v0.1.811](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.811) — 2026-09-01
- feat(web): native Windows caption buttons with Electron-matching sizing — efe044dd
- feat(desktop): add search-op IPC + browse-path parity for shared web code — 222d2ff7
- fix(tauri): glue execute envelope + shell parity with Electron — b9f8745c
...
## [v0.1.808](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.808) — 2026-09-01
- fix(gateway): batch session-event persistence to stop chat streaming stalls — 0375efc8
- feat(desktop-tauri): add tray, single-instance focus, and launch-flag argv handling — e3581f6d

## [v0.1.807](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.807) — 2026-09-01
- fix(desktop-tauri): reach Electron parity for path handling and node ops — c65fc440
- fix(web): hide floating chat indicators when the chat panel is too narrow — 159ae81a
...
## [v0.1.804](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.804) — 2026-09-01
- fix(gateway): wrap PowerShell terminal input in bracketed paste to stop PSReadLine echo doubling — 1e9006c9
- fix(web,desktop-tauri): let unreachable-gateway screen set the backend URL — be9e6976
...
## [v0.1.761](https://github.com/Widev-e-U/Jait/releases/tag/v0.1.761) — 2026-08-24
- fix(web): scope tool terminal output to each command — 5c88b49c
- fix(gateway): route MCP terminal calls through the remote node executor — 42e0a521
